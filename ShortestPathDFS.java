...
public class ShortestPathDFS {
    ...
    private Stack<String> open;
    private Queue<String> closed;
    private Map<String, String> path;
    private Set<String> finalStates;
    private Map<String, Integer> distances;  // Store distances separately

    public ShortestPathDFS(CityGraph cityGraph) {
        ...
        while (!open.isEmpty()) {
            ...
            for (Map.Entry<String, Integer> entry : successors.entrySet()) {
                ...
                if (!closed.contains(successor) && !open.contains(successor)) {
                    ...
                    path.put(successor, currentCity);
                    distances.put(successor, distances.get(currentCity) + distanceToSuccessor);
                    open.push(successor);  // Add successor to open even if it was closed
                }
            }
        }
